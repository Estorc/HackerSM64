...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_PARTICLE,          mario_particle_geo),
...
const LevelScript script_func_global_1[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_WOOD_CRATE,              wood_crate_geo),
    LOAD_MODEL_FROM_GEO(MODEL_IRON_CRATE,              iron_crate_geo),
    LOAD_MODEL_FROM_GEO(MODEL_WARP_PIPE,               warp_pipe_geo),
    LOAD_MODEL_FROM_GEO(MODEL_IRON_CAGE,               iron_cage_geo),
    LOAD_MODEL_FROM_GEO(MODEL_ANTI_GRAV_OLIVE,         anti_gravity_olive_geo),
    LOAD_MODEL_FROM_GEO(MODEL_JOHN_PILLAR,             john_pillar_geo),
    LOAD_MODEL_FROM_GEO(MODEL_PIZZA_FACE,              pizza_face_geo),
    LOAD_MODEL_FROM_GEO(MODEL_ROCKET,                  rocket_geo),
    LOAD_MODEL_FROM_GEO(MODEL_ROCKET_OBSTACLE_1,       rocket_obstacle_1_geo),
